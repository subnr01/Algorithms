    ...
    extends TestCase
{
    ...
    public void testNext()
    {
        ...
        test.next();
        assertEquals("10", test.getCurrent());

        test.next();
        assertEquals("9", test.getCurrent());

        test.next();
        assertEquals("8", test.getCurrent());

        test.next();
        assertEquals("7", test.getCurrent());
        ...
        test.next();
        test.next();
        assertEquals("11", test.getCurrent());
    }
